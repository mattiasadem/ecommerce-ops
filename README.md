...
│   ├── app/                               ← 12 routes: /, /top-10, /playbooks, /assets,
│   │                                       /journal, /30-day-plan, /ai, /channels, /cro,
│   │                                       /inventory, /retention, /unit-economics
│   └── src/lib/content.json               ← auto-generated index of research/ + playbooks/ + assets/
├── assets/                                ← 12 shipped: copy templates (8 Klaviyo+Postscript
